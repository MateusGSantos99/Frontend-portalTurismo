...
import coliseu from "../assets/imagens/coliseu.jpg"
import eifel from "../assets/imagens/eifel.jpg"
import louvre from "../assets/imagens/louvre.jpg"
import maracana from "../assets/imagens/maracana.jpg"
import muralha from "../assets/imagens/muralha.jpg"
import TajMahal from "../assets/imagens/tajmahal.jpg"

// Array de objetos com dados dos pontos turísticos (imagem, título e descrição)
const tourist_places = [
    { Image: coliseu, title: " Coliseu", description: " Ponto turistico italiano" },
    { Image: eifel, title: " Torre Eifel", description: " Grande torre de Paris" },
    { Image: louvre, title: "Piramide do louvre", description: " Ponto turistico frances" },
    { Image: maracana, title: "Maracanã", description: " Estádio histórico do Rio de Janeiro" },
    { Image: muralha, title: " Muralha da China", description: " Grande muralha da China" },
    { Image: TajMahal, title: " Taj Mahal", description: " Estrutura histórica da India" },
]
